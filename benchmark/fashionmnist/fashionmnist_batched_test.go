...
// TestFashionMNISTBatched runs the tuned configuration with mini-batch
// parallel training.
//
// Architecture: 784 → 512 hidden (30% sparse) → 10 output
// Same hyperparameters as TestFashionMNISTTuned but with mini-batch
// gradient averaging and parallel gradient computation.
func TestFashionMNISTBatched(t *testing.T) {
