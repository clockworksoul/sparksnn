// Package fashionmnist provides the Fashion-MNIST clothing classification
// task for benchmarking learning rules. Fashion-MNIST has 784 features
// (28x28 grayscale pixels) and 10 classes (T-shirt/top, Trouser, Pullover,
// Dress, Coat, Sandal, Shirt, Sneaker, Bag, Ankle boot).
//
// Data format is identical to MNIST (gzipped IDX files) and is loaded
// from data/fashionmnist/.
...
// ClassNames maps label indices to human-readable class names.
...
// Task implements the Fashion-MNIST benchmark.
type Task struct {
	train []benchmark.Sample
	test  []benchmark.Sample
}

func (t *Task) Name() string       { return "Fashion-MNIST" }
...
// NewTask loads Fashion-MNIST from the data/fashionmnist/ directory.
...
// findDataDir locates the data/fashionmnist/ directory relative to
// this source file.
func findDataDir() string {
	_, thisFile, _, _ := runtime.Caller(0)
	return filepath.Join(filepath.Dir(thisFile), "..", "..", "data", "fashionmnist")
}
